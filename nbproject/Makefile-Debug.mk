...
OBJECTFILES= \
	...
	${OBJECTDIR}/DeAmortizedSDdNoOMAP.o \
...
${OBJECTDIR}/DeAmortizedSDdNoOMAP.o: DeAmortizedSDdNoOMAP.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeAmortizedSDdNoOMAP.o DeAmortizedSDdNoOMAP.cpp
...
${OBJECTDIR}/OneChoiceSDdNoOMAPClient.o: OneChoiceSDdNoOMAPClient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OneChoiceSDdNoOMAPClient.o OneChoiceSDdNoOMAPClient.cpp

${OBJECTDIR}/OneChoiceSDdNoOMAPServer.o: OneChoiceSDdNoOMAPServer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OneChoiceSDdNoOMAPServer.o OneChoiceSDdNoOMAPServer.cpp

${OBJECTDIR}/OneChoiceSDdNoOMAPStorage.o: OneChoiceSDdNoOMAPStorage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OneChoiceSDdNoOMAPStorage.o OneChoiceSDdNoOMAPStorage.cpp
...
${OBJECTDIR}/TwoChoicePPwithStashClient.o: TwoChoicePPwithStashClient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TwoChoicePPwithStashClient.o TwoChoicePPwithStashClient.cpp

${OBJECTDIR}/TwoChoicePPwithStashServer.o: TwoChoicePPwithStashServer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TwoChoicePPwithStashServer.o TwoChoicePPwithStashServer.cpp

${OBJECTDIR}/TwoChoicePPwithStashStorage.o: TwoChoicePPwithStashStorage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TwoChoicePPwithStashStorage.o TwoChoicePPwithStashStorage.cpp
